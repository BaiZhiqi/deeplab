...
def preprocess_data_folder(data_folder):
    ...
    dataset = load_data(image_data_folder, label_folder,ext='jpg',
...
def read_label(full_label_name, n_classes):
    scaled_label = imread(full_label_name) / 127
...
if __name__ == "__main__":
    preprocess_data_folder('/home/bai/LiverSegmentation-master/data/')